Config = {
    ...
    Text = {
        ...
        POOL = 'Bilhar',
        POOL_GAME = 'Jogo Sinuca',
        POOL_SUBMENU = 'Modo de Jogo',
        TYPE_8_BALL = '8-Ball',
        TYPE_STRAIGHT = 'Sinuca',

        HINT_SETUP = 'Instalar Jogo',
        HINT_TAKE_CUE = 'Pegue um Taco.',
        HINT_RETURN_CUE = 'coloque de volta o Taco.',
        ...
        BALL_POCKETED = 'Você matou a bola %s',
        BALL_IN_HAND_NOTIFY = 'Você tem a bola de bilhar em suas mãos',
        BALL_LABELS = {
            [-1] = 'Branca',
            [1] = '~y~Solida 1~s~',
            [2] = '~b~Solida 2~s~',
