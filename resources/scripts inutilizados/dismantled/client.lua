...
-- CONFIG
-----------------------------------------------------------------------------------------------------------------------------------------
local IniciarServico = { 2050.29,3198.1,45.19 } -- Onde se inicia o serviço e verifica a existência de um carro
local LocalDesmancharCarro = { 2052.24,3193.11,45.19,331.66 } -- Onde deve haver o carro que será desmanchado para poder continuar o desmanche
local LocalFerramentas = { 2055.67,3189.02,45.19,59.53 } -- Local onde 'pegará' as ferramentas
local AnuncioChassi = { 2057.52,3194.1,45.19,328.82 } -- Onde finalizará a missão para entregar o chassi e receber dinheiro e itens
local Computador = { 2056.0,3195.53,45.19,331.66 } -- Local onde ficará o computador de venda
---------------------------------------------------------------------
--VARIAVEIS
---------------------------------------------------------------------
local blips = {}
                                ...
                                if VehPermitido then 
                                    if CheckVehPermitido(nomeCarro) then
                                        if vSERVER.CheckItem() then
                                            ...
                                            TriggerEvent('Notify','vermelho','ERRO AO INICIAR O SERVIÇO! Você necessita de uma <b>Chave englesa !!</b> para iniciar o serviço.',10000)
                                        end
                                    else
