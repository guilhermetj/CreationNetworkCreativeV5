...
window.addEventListener('message', function(event) {
    switch (event.data.action) {
            ...
            if (selectedWindow == "none") {
                ...
                $('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Carregando Dados...</div>
					</div>
				`);
                $("#menu").fadeIn();
                $(".main_card").fadeIn();
							...
							<div class="d-flex justify-content-between align-items-center">
								...
								<div>
									...
									<div style="font-size: 14px; margin-top: -12px; font-weight: 500; position: absolute; right: 7.2%;">
										<span>Carteira: <span id="wallet_money"></span>$</span>
									</div>
								</div>
							</div>
							<hr>
        ...
        case 'multas_page':
            ...
            $('#page-title').html('Multas');

            if (event.data.isInSociety) {
                society = `<span class="sidebar-title mt-5">Society</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão Geral</span></p>
						   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>`;
            } else {
                society = '';
            }

            $('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão Geral</span></p>
				<p class="sidebar-item mt-2" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Configurações</span></p>
				${society}
			`);
            ...
            for (var i = 0; i < num; i++) {
                ...
                data = `<td class="align-middle" style="font-weight: 500;">
					De <span style="color: #7713a5; font-weight: 600;">${db.nuser_id}</span>
					<div style="margin-top: -5px;">${db.date}</div>
				</td>`;
                amount = `<td class="align-middle pay-fine" data-id-key="${db.id}" data-price-key="${db.price}" style="font-weight: 500;"><span style="color: #6b1692; float: right;"> ${db.price.toLocaleString()}</span> </td>`;

                row += `
					<tr>
						${icon}
						${data}
						<td class="align-middle" style="font-weight: 500;">${db.text}</td>
						${amount}
					</tr>
				`;
            }
					...
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								...
								<div style="margin-top: -5px;">Enviado</div>
							</td>
						...
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Em <span style="color: #1f5eff;">Conta bancária</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #6b1692;">+ 57 000$</td>
						</tr>
					</tbody>
				</table>
			`);
        ...
        case 'society_transactions':
            ...
            $('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão Geral</span></p>
				<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Configurações</span></p>
            ...
            for (var i = 0; i < num; i++) {
                ...
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #6b1692d8; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Received</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Sent
                } else if (db.type == 'transfer' && db.sender_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #6b1692d8; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #6b1692d8; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								Em <span style="color: #1f5eff; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Withdrawn
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Sacado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()}$</span> </td>`;
                }
            ...
            $('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #6b1692d8; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TRANSAÇÕES</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">RENDA</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">RESULTADO</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">GANHOS</h6>
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #7713a5;">Arthur James</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500;">- 732 500$</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Em <span style="color: #7713a5;">Conta do banco</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #6b1692;">+ 57 000$</td>
        ...
        case 'transactions_page':
            ...
            $('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão Geral</span></p>
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Configurações</span></p>
				${society}
			`);
            ...
            for (var i = 0; i < num; i++) {
                ...
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #7713a5; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Recebido</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Sent
                } else if (db.type == 'transfer' && db.sender_identifier == event.data.identifier) {
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #7713a5; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()}$</span> </td>`;
                    // Deposited
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								Em <span style="color: #7713a5; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Withdrawn
            ...
            $('#page_info').html(`
				<div class="row mb-3">
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #6b1692d8; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">RENDIMENTO</h6>
						    <p class="card-text" id="totalIncome" style="font-size: 20px;">${event.data.graph_values[7].toLocaleString()}$</p>
						  </div>
						</div>
					</div>
...
$(document).on('click', "#overview_page", function() {
    $.post('https://RazeBank/action', JSON.stringify({
...
// Multas
//$(document).on('click', "#multas_page", function() {
//    $.post('https://RazeBank/action', JSON.stringify({
//        action: "multas_page",
//    }));
//});
$(document).on('click', ".pay-fine", function() {
    let $el = $('.pay-fine');
    $.post("http://RazeBank/finesPayment", JSON.stringify({
...
$(document).on('click', ".finesMoneyModal", function() {
    var modalId = $('#finesModal');
    var depositModal = new bootstrap.Modal(modalId);
    depositModal.show()
});
...
$(document).on('click', '#finesMoney', function() {
    ...
    $('#fines_value').val('');
    document.getElementById('finesMoney').disabled = true;
})
...
function checkIfEmpty() {
    ...
    // Fines
    if (document.getElementById("fines_value").value === "") {
        document.getElementById('finesMoney').disabled = true;
    } else {
        document.getElementById('finesMoney').disabled = false;
    }
...
function overview_page_function(event) {
    ...
    $('#sidebar').html(`
		<p class="sidebar-item mt-2 selected" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão geral</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>
		<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Configurações</span></p>
		${society}
	`);
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Estatísticas</span>
				</div>
				...
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Últimas Transações</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> VER TUDO</span></span>
						</div>
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											De <span style="color: #1f5eff;">Arthur James</span>
											<div style="margin-top: -5px;">Recebido</div>
										</td>
										<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692;">+ 12 750$</span> </td>
									</tr>
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											De <span style="color: #1f5eff;">Conta bancária</span>
											<div style="margin-top: -5px;">Sacado</div>
										</td>
									...
									<tr>
										...
										<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692;">+ 57 000$</span> </td>
									</tr>
								</tbody>
							</table>
						</div>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="bi bi-credit-card-fill"></i> Informações</span>
					</div>
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">NuBank Classic</span></span><span><i class="fas fa-wifi"></i></span></span>
				...
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="fas fa-list-ul"></i> Ações</span>
					</div>
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<div class="d-flex justify-content-center">
							<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Depositar</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="withdrawMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#withdrawModal"><i class="bi bi-download"></i> Sacar</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="transferMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#transferModal"><i class="fas fa-exchange-alt"></i> Transferir</button>
						</div>
                        <div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="finesMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#finesModal"><i class="fa-light fa-file-invoice-dollar"></i> Pagar Multas</button>
						</div>
    ...
    for (var i = 0; i < num; i++) {
        ...
        if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
            ...
            amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()}$</span> </td>`;
            // salary
        } else if (db.type == 'salary') {
            icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
            data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						Em <span style="color: #7713a5; font-weight: 600;">${db.receiver_name}</span>
						<div style="margin-top: -5px;">Salário</div>
					</td>`;
            amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #6b1692; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
        }
    ...
    gradient.addColorStop(0, 'rgba(105, 19, 175, 0.808)');
    gradient.addColorStop(1, 'rgba(105, 19, 175, 0.808)');
...
function society_page_function(event) {
    ...
    if (event.data.isInSociety) {
        society = `<span class="sidebar-title mt-5">Society</span>
				   <p class="sidebar-item mt-2 selected" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão geral</span></p>
				   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>`;
    } else {
        society = '';
    }
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Últimas Transações</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions_society"><i class="fas fa-eye"></i> VER TUDO</span></span>
						</div>
						<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
			...
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Bank Society</span></span><span><i class="fas fa-wifi"></i></span></span>
								<div style="margin-top: 38%;">
									<div class="d-flex align-items-center">
										<span style="font-weight: 500; color: #fff; line-height: 1;">Status</span>
									</div>
									<div class="d-flex justify-content-between align-items-center">
										<span style="color: #fff; font-size: 24px; color: #fff; line-height: 1; text-shadow: 0px 0px 2px rgba(255, 255, 255, 0.5);">ATIVO</span>
										<div class="d-flex align-items-center" style="width: 25px; line-height: 1; margin-right: 34px;">
											<span style="color: #fff; font-size: 8px; font-weight: 500; margin-right: 3px;">VALID THRU</span>
											<span style="color: #fff; font-weight: 500; font-size: 16px;">08/25</span>
										</div>
				...
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                        ...
                        <div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="finesMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#finesModal"><i class="fa-light fa-file-invoice"></i> Pagar Multas</button>
						</div>
					</div>
				</div>
			</div>
...
function settings_page_function(event) {
    ...
    $('#sidebar').html(`
		<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Visão Geral</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transações</span></p>
		<p class="sidebar-item mt-2 selected" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Configurações</span></p>
		${society}
	`);
			...
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
				<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;">
						<span><i class="fas fa-key"></i> Código PIN</span>
					</span>
				</div>
				<div class="card-body flex-grow-1" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Mudar PIN</span>
									<input type="password" maxlength="4" id="new_pin" class="form-control text-center" placeholder="Novo PIN" onkeyup="checkIfEmptySettings()" style="margin-top: 12px; width: 100%;">
									<button type="button" id="change_pin" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Enviar</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #6b1692d8; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>O PIN tem um custo de mudança de ${event.data.pinCost}$</span>
								    <hr style="color: #fff;">
									<span>O número máximo de caracteres é ${event.data.pinCharNum}</span>
									<hr style="color: #fff;">
									<span>Você só pode usar números</span>
								  </div>
								</div>
							</div>
						</div>
    ...
    setTimeout(function() {
        $('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div style="font-size: 40px; color: #fff;">Saindo...</div>
			</div>
		`);
        $("#menu").fadeIn();
