...
AddEventHandler("vRP:playerActive",function(user_id,name,players)
	LocalPlayer["state"]["Active"] = true

	SetDiscordAppId(934134712954408990)
	SetDiscordRichPresenceAsset("Creation Network")
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("Creation Network")
	SetDiscordRichPresenceAssetText("Creation Network")
	SetDiscordRichPresenceAssetSmallText("Creation Network")
	SetDiscordRichPresenceAction(0,"Discord","https://discord.gg/XBP9Fm3ymK")
	SetDiscordRichPresenceAction(1,"Loja","")
