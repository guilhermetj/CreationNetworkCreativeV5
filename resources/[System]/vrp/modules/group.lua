...
AddEventHandler("playerConnect",function(user_id,source)
	...
	if vRP.hasPermission(user_id,"Policia") then
		permList["Police"][user_id] = source
		TriggerClientEvent("vRP:PoliceService",source,true)
		TriggerEvent("blipsystem:serviceEnter",source,"POLICE: Policia",18)
	...
	if vRP.hasGroup(user_id,"Custombrasil") then
		permList["Custombrasil"][user_id] = source
		TriggerClientEvent("service:Label",source,"Custombrasil","Sair de Serviço",5000)
	end
