		...
		if not IsPedInAnyVehicle(ped) then
			...
			if serviceStatus then
				...
				if distance <= 100 then
					...
					DrawMarker(21,stopVehicle[locateSelect][selectPosition][1],stopVehicle[locateSelect][selectPosition][2],stopVehicle[locateSelect][selectPosition][3],0,0,0,0,180.0,130.0,1.5,1.5,1.0,40,137,182,100,0,0,0,1)
