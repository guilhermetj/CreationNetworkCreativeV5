...
AddEventHandler("vRP:playerLeave",function(user_id,source)
	if activeWorks["Favela01"][user_id] then
		activeWorks["Favela01"][user_id] = nil
	end

	if activeWorks["Favela02"][user_id] then
		activeWorks["Favela02"][user_id] = nil
	end
	
	if activeWorks["Favela03"][user_id] then
		activeWorks["Favela03"][user_id] = nil
	end

	if activeWorks["Favela04"][user_id] then
		activeWorks["Favela04"][user_id] = nil
	end
