...
-- Pagar Multas
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("pagarmultas",function(source,args,rawCmd)
    local source = source
    local user_id = vRP.getUserId(source)
...
function cRP.receiveSalary()
	...
	if user_id then
		...
		if vRP.hasGroup(user_id,"Emergency") then
			...
			TriggerClientEvent("Notify",source,"azul","Salário de <b>$7.500</b> recebido.",5000)
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	if exports["chat"]:statusChat(source) then
		...
		if user_id and args[1] and vRP.getHealth(source) > 101 then
			if vRP.hasGroup(user_id,"Police") then
				...
				elseif vRP.hasPermission(user_id,"Policia") then
					department = "Policia"
...
local preset = {
	["1"] = {
		["mp_m_freemode_01"] = {
			...
			["tshirt"] = { item = 27, texture = 0 },
			["torso"] = { item = 16, texture = 1 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 52, texture = 0 },
	...
	["2"] = {
		...
		["mp_f_freemode_01"] = {
			["hat"] = { item = -1, texture = 0 },
			["pants"] = { item = 141, texture = 4 },
			["vest"] = { item = 27, texture = 1 },
			["bracelet"] = { item = -1, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = 121, texture = 0 },
			["shoes"] = { item = 25, texture = 0 },
	...
	["6"] = {
		...
		["mp_f_freemode_01"] = {
			...
			["tshirt"] = { item = 75, texture = 0 },
			["torso"] = { item = 533, texture = 0 },
			["accessory"] = { item = 110, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 105, texture = 1 },
			["glass"] = { item = 0, texture = 0 },
			["ear"] = { item = -1, texture = 0 }
		}
	},
	["7"] = {
		...
		["mp_f_freemode_01"] = {
			...
			["torso"] = { item = 24, texture = 2 },
			["accessory"] = { item = 111, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
