...
local benCoords = { -55.26,-1096.39,26.42 }
-----------------------------------------------------------------------------------------------------------------------------------------
-- REQUESTDRIVE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNUICallback("requestDrive",function(data,cb)
	...
	if distance <= 10 then
		...
		TriggerEvent("Notify","amarelo","Dirija-se até a <b>Concessionária</b> para efetuar o teste.",2000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHCREATE
...
function vehCreate(vehName,vehPlate)
	...
	if HasModelLoaded(mHash) then
		vehDrive = CreateVehicle(mHash,-61.01,-1072.93,26.54,68.04,false,false)
...
local Vehicles = {
	{
		["coords"] = vector3(-786.02,-245.36,37.07),
		["heading"] = 62.37,
		["model"] = "camaro",
		["distance"] = 50
	-- },{
	...
	-- 	["distance"] = 50
		...
		["coords"] = vector3(-790.91,-235.78,37.07),
		["heading"] = 70.87,
		["model"] = "golfgti",
		["distance"] = 30
	},{
		["coords"] = vector3(-788.14,-240.38,37.07),
		["heading"] = 65.2,
		["model"] = "vwtouareg",
		["distance"] = 30
	}
