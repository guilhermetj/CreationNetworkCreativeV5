vehicleCustomisationPrices = {
	cosmetics = 1250,
	respray = 1250,
	engines = { 25000, 17250, 27250, 37250, 47250, 57250 },
	brakes = { 25000, 37250, 47250, 57250, 67250, 77250 },
	transmission = { 25000, 32250, 42250, 52250, 62250, 72250 },
	suspension = { 25000, 17250, 27250, 37250, 47250, 57250 },
	shield = { 25000, 27250, 42250, 57250, 72250, 87250 },
	turbo = 7250,
	wheels = 1250,
	customwheels = 1250,
	wheelsmoke = 775,
