...
RegisterNetEvent("admin:armored")
AddEventHandler("admin:armored",function(index,fix)
    if NetworkDoesNetworkIdExist(index) then
        ...
        if DoesEntityExist(v) then
            ...
            NetworkSetVehicleWheelsDestructible(v,false)
            SetVehicleHasUnbreakableLights(v,true)
            SetVehicleCanBreak(v,false)
            SetVehicleCanBeVisiblyDamaged(v,false)
            SetVehicleCanLeakOil(v,false)
            SetVehicleCanLeakPetrol(v,false)
...
-- IMORTAL
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand('deus',function(source,args)
...
RegisterKeyMapping("nc2","Owner: Noclip","keyboard","o")
-----------------------------------------------------------------------------------------------------------------------------------------
-- [ DEBUG ] 
-----------------------------------------------------------------------------------------------------------------------------------------
