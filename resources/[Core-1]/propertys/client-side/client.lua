						...
						if distance <= 1.25 then
							...
							if IsControlJustPressed(1,38) and GetGameTimer() >= homes["pressButton"] and MumbleIsConnected() then
								if vSERVER.checkOwner(k) then
									...
									exports["dynamic"]:AddButton("Permissões","Checar permissões da propriedade.","homes:permissionsCheck",k,"Permissions",true)
									exports["dynamic"]:AddButton("Adicionar","Adicionar morador nesta propriedade.","homes:permissionsAdd",k,"Permissions",true)
									exports["dynamic"]:SubMenu("Diagrama","Informações sobre o uso.","Diagram")
									exports["dynamic"]:AddButton("Aumentar Armário","Adiciona mais <yellow>10Kg</yellow> no <yellow>Armário</yellow>.","homes:upgradeVault",k,"Diagram",true)
									exports["dynamic"]:AddButton("Aumentar Geladeira","Adiciona mais <yellow>10Kg</yellow> na <yellow>Geladeira</yellow>.","homes:upgradeFridge",k,"Diagram",true)
