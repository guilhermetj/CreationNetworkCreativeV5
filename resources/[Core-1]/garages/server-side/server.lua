...
local garageLocates = {
	...
	["27"] = { name = "Garage", payment = false },
	["28"] = { name = "Garage", payment = false },--favela01
	["29"] = { name = "Garage", payment = false },--favela01
	["30"] = { name = "Garage", payment = false },--favela02
	["31"] = { name = "Garage", payment = false },--favela02
	["32"] = { name = "Garage", payment = false },--favela03
	["33"] = { name = "Garage", payment = false },--favela03
	["34"] = { name = "Garage", payment = false },--favela04
	["35"] = { name = "Garage", payment = false },--favela04
	["36"] = { name = "Garage", payment = false },--Mafia
	["37"] = { name = "Garage", payment = false },--Mafia
	["38"] = { name = "Garage", payment = false },--Vinhedo
	["39"] = { name = "Garage", payment = false },--Vinhedo
	["40"] = { name = "Garage", payment = false },--Bunker
	["47"] = { name = "Garage", payment = false },--Bunker
	["48"] = { name = "Garage", payment = false },--Bennys
	["49"] = { name = "Garage", payment = false },--Lester
