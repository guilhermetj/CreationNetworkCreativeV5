...
local pedList = {
	{ -- tragemergulhador
	distance = 30,
	coords = { -815.26,-1346.76,5.14,45.36 },
	...
	{ -- Concessionária Sul
	distance = 30,
	coords = { -56.8,-1098.71,26.42,19.85 }, 
	model = { 0xC85F0A88,"mp_m_boatstaff_01" },
	anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- TowDriver
		distance = 100,
	...
	{ -- TowDriver
		distance = 30,
		coords = { 409.02,-1622.8,29.28,229.61},
		model = { 0xF1E823A2,"g_m_m_armboss_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- WeedShop
		distance = 30,
		coords = { -1173.08,-1572.77,4.67,121.89 },
	...
	{ -- Ilegal
		distance = 100,
		coords = { 203.54,-1494.23,35.82,127.56 },
		model = { 0x158C439C,"g_f_y_ballas_01" },
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Ilegal
	...
	{ -- Police
		distance = 100,
		coords = { 393.55,-1632.97,29.28,51.03 },
	...
	{ -- Departament Store
		distance = 10,
		coords = { -549.04,-582.96,34.68,187.09 },
		model = { 0x18CE57D0,"mp_m_shopkeep_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Departament Store
	...
	{ -- Ammu-Nation Store
		distance = 12,
		coords = { -544.95,-585.11,34.68,266.46 },
		model = { 0x467415E9,"ig_dale" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Ammu-Nation Store
	...
	{ -- Mercado Central
		distance = 50,
		coords = { -528.19,-582.75,34.68,184.26 },
		model = { 0x5D71A46F,"s_f_y_airhostess_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Mercado Crafting
	...
	{ -- Animal Park
	distance = 15,
	coords = { 1522.82,3783.59,34.47,212.6 },
	model = { 0x51C03FA4,"a_f_y_eastsa_03" },
	anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
},
	{ -- Pescador
