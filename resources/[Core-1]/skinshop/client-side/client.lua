...
AddEventHandler("changeClothes", function(index, color, type_clothe)
    ...
    if GetEntityHealth(ped) > 101 then
        ...
        if v then
            ...
            if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") or GetEntityModel(ped) ==
...
function GetMaxValues()
    ...
    for k, v in pairs(clothingCategorys) do
        ...
        if v["type"] == "prop" then
            ...
            maxModelValues[k]["texture"] = GetNumberOfPedPropTextureVariations(ped, v["id"],
                GetPedPropIndex(ped, v["id"])) - 1
