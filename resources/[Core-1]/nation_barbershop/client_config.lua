...
local barberChairs = {
    ...
    [8] = {
        { coords = vec3(-556.62,-587.47,41.57), h = 90.71, offset = vec3(0.03, -0.75, 0.0) },
        { coords = vec3(-556.65,-585.49,41.59), h = 90.71,  offset = vec3(-0.02, -0.75, 0.0) },
        { coords = vec3(-556.62,-583.56,41.57), h = 90.71,  offset = vec3(-0.04, -0.75, 0.0) },  
    }
}
