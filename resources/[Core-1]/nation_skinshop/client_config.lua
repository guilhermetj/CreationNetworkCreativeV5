...
skinshops = {
    ...
    [17] = {
     ...
     [18] = {
         clothes = getClothes, permission = nil, coords = vec3(-1284.68,-1721.65,6.13) -- FAVELA PRAIA
    },
    [19] = {
    ...
    [74] = {
        clothes = getClothes, permission = nil, coords = vec3(812.97113037109, -927.95782470703, 32.392658233643)
    }, --Bravo
    [75] = {
        clothes = getClothes, permission = nil, coords = vec3(-339.43768310547, -162.14460754395, 44.587581634521)
    }, --Brooklyn
    [76] = {
...
function fclient.getCloths()
    ...
    for cloth, comp in pairs(skinData) do
        ...
        cloths[cloth] = {texture = texture, item = item}
    end
    return cloths
end
