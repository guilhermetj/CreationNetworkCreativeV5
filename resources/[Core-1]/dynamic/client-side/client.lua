...
RegisterCommand("globalFunctions",function(source,args,rawCommand)
	if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and MumbleIsConnected() then
		...
		if GetEntityHealth(ped) > 101 then
			...
			exports["dynamic"]:AddButton("Comercializar","Comercialização de Produtos","drugs:toggleService","","others",false)
			exports["dynamic"]:AddButton("Propriedades","Ativa/Desativa as propriedades no mapa.","propertys:Blips","","others",false)
		...
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and MumbleIsConnected() then
			...
			if GetEntityHealth(ped) > 101 then
				...
				if LocalPlayer["state"]["Police"] then
					...
					exports["dynamic"]:AddButton("CORE","Fardamento de oficial.","player:presetFunctions","1","prePolice",true)
					exports["dynamic"]:AddButton("GAR","Fardamento de oficial.","player:presetFunctions","2","prePolice",true)
					exports["dynamic"]:AddButton("GTM","Fardamento de oficial.","player:presetFunctions","3","prePolice",true)
					exports["dynamic"]:AddButton("GAEP","Fardamento de oficial.","player:presetFunctions","4","prePolice",true)
					exports["dynamic"]:AddButton("Policia","Fardamento de oficial.","player:presetFunctions","5","prePolice",true)
				...
				elseif LocalPlayer["state"]["Paramedic"] then
					...
					exports["dynamic"]:AddButton("Paramedic Center","Fardamento de paramédico.","player:presetFunctions","7","preMedic",true)
					exports["dynamic"]:AddButton("Paramedic2 Center","Fardamento de paramédico interno.","player:presetFunctions","8","preMedic",true)
